...
export async function discoverMcpTools(
  ...
  try {
    mcpServers = appendMcpServerCommand(mcpServers, mcpServerCommand);
...
/** Visible for Testing */
export function appendMcpServerCommand(
  mcpServers: Record<string, MCPServerConfig>,
  mcpServerCommand: string | undefined,
...
export async function connectAndDiscover(
  ...
  try {
    const mcpClient = await connectToMcpServer(mcpServerName, mcpServerConfig);
    try {
      ...
      const tools = await dicoverTools(
        mcpServerName,
        mcpServerConfig,
        mcpClient,
      );
 ...
 */
export async function dicoverTools(
  mcpServerName: string,
  mcpServerConfig: MCPServerConfig,
  mcpClient: Client,
...
export async function connectToMcpServer(
  ...
  try {
    const transport = createTransport(mcpServerConfig);
    try {
...
/** Visible for Testing */
export function createTransport(mcpServerConfig: MCPServerConfig): Transport {
